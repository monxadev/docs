...
Monxa webhooks notify you of key events across payments, refunds, captures, voids, and batch operations. These events help you track the full payment lifecycle and automate workflows in real time.
...
Monxa settlement webhooks notify you whenever a settlement changes state. These events help you track the full settlement lifecycle, from creation to completion (or rejection).
