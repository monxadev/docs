...
<Columns cols={2}>
  ...
  <Card title="3. Customer Scans & Pays" icon="qrcode-read" iconType="solid" href="#">
...
<Tabs>
  ...
  <Tab title="🇹🇭 Thailand">
    | **Channel** | Code           | **Currency** | **Refund**    | **Settlement** | Min Amount | Max Amount |
    | :---------- | -------------- | :----------- | :------------ | :------------- | :--------- | ---------- |
    | PromptPay   | `qr_promptay`  | THB          | Not supported | T+2            | 1          | 50,000     |
    | TrueMoney   | `qr_truemoney` | THB          | Not supported | T+2            | 1          | 70,000     |
  </Tab>
</Tabs>
