...
<Tabs>
  ...
  <Tab title="Thailand">
    | **Channel** | Code               | **Currency** | **Refund**        | **Settlement** | Min Amount | Max Amount |
    | :---------- | ------------------ | :----------- | :---------------- | :------------- | :--------- | ---------- |
    | Alipay      | `alipay_wallet`    | THB          | Not supported     | T+2            | 1          | 50,000     |
    | WeChat Pay  | `wechatpay_wallet` | THB          | Not supported     | T+2            | 1          | 70,000     |
    | TrueMoney   | `truemoney_wallet` | THB          | Not supported     | T+2            | 1          | 50,000     |
    | LINE Pay    | `linepay_wallet`   | THB          | 3-5 business days | T+2            | 1          | 50,000     |
  </Tab>
</Tabs>
