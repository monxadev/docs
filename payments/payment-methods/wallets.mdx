...
<Columns cols={2}>
  ...
  <Card title="2. Redirect Customer to e-Wallet" icon="qrcode" iconType="solid" href="#">
    Use the `return_url` from Monxa to send the customer to their e-wallet app or page to continue the payment.
  </Card>
  <Card title="3. Customer Authorizes Payment" icon="camera" iconType="solid" href="#">
