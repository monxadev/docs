...
<CardGroup cols={2}>
  ...
  <Card title="Role-based User Permissions" icon="users" iconType="solid" href="/security/user-permissions">
    - Assign access levels to team members to minimize unnecessary exposure of sensitive data.
  </Card>
  <Card title="Secure API Keys" icon="key" href="/security/api-keys">
    - Generate and manage keys with granular scopes to limit system access.
  </Card>
  <Card title="IP Whitelisting" icon="ban" href="/security/ip-whitelisting">
    Limits access to Monxa’s platform by allowing API requests only from trusted IP addresses.
  </Card>
  <Card title="Integration Best Practices" icon="sparkles" href="/security/integration-security">
    - Follow Monxa’s guidelines to ensure your payment integrations remain secure.
  </Card>
  <Card title="Webhooks Handling" icon="anchor" href="/security/webhook-handling">
